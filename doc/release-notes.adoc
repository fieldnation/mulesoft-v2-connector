...
The Fieldnation V2 Connector enables businesses to connect to Fieldnation in a user friendly manner by leveraging the Fieldnation REST APIs. 

Using this connector, businesses can create instant connectivity between Fieldnation and many other 3rd party and/or legacy systems. 
