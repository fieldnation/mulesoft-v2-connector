...
import com.fieldnation.models.Country;
...
public class Countries {
  ...
  **/
  ...
  public Countries results(List<Country> results) {
    this.results = results;
    return this;
  }

  public Countries addResultsItem(Country resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Country>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.metadata, countries.metadata) &&
        Objects.equals(this.results, countries.results);
  }
