...
public class Shipments {
  ...
  private List<Shipment> results = null;
  ...
  **/
  ...
  public Shipments addResultsItem(Shipment resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Shipment>();
    }
  ...
  **/
  ...
  public Shipments actions(List<ActionsEnum> actions) {
    this.actions = actions;
    return this;
  }

  public Shipments addActionsItem(ActionsEnum actionsItem) {
