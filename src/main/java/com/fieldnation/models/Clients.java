...
public class Clients {
  ...
  public Clients metadata(ListEnvelope metadata) {
  ...
  **/
  ...
  public Clients results(List<Client> results) {
    this.results = results;
    return this;
  }

  public Clients addResultsItem(Client resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Client>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.metadata, clients.metadata) &&
        Objects.equals(this.results, clients.results);
  }
