...
@RunWith(Suite.class)
@SuiteClasses({ AddWorkorderTestCases.class, AssignWorkorderTestCases.class, AutoDispatchWorkorderTestCases.class,
		GenerateAccessTokenTestCases.class, GetTokenDetailsTestCases.class, PublishWorkorderTestCases.class,
		RouteWorkorderTestCases.class, UpdatePayTestCases.class, UpdateScheduleTestCases.class })
